...
POWEROPCODE(dozi);
OPCODEREC(power_lscbx);
OPCODEREC(power_maskg);
OPCODEREC(power_maskir);
POWEROPCODEOVREC(mul);
POWEROPCODEOVREC(nabs);
POWEROPCODE(rlmi);
POWEROPCODEOVREC(rrib);
POWEROPCODEOVREC(sle);
POWEROPCODEOVREC(sleq);
POWEROPCODEOVREC(sliq);
POWEROPCODEOVREC(slliq);
POWEROPCODEOVREC(sllq);
POWEROPCODEOVREC(slq);
POWEROPCODEOVREC(sraiq);
POWEROPCODEOVREC(sraq);
POWEROPCODEOVREC(sre);
POWEROPCODEOVREC(srea);
POWEROPCODEOVREC(sreq);
POWEROPCODEOVREC(sriq);
POWEROPCODEOVREC(srliq);
POWEROPCODEOVREC(srlq);
POWEROPCODEOVREC(srq);
