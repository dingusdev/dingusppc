...
- Open Firmware 1.0.5 incorrectly reads PCI2 PRSNT bits from IOBus device #3 at 0xF301C000. The correct location of those bits is Board Register 2 that appears as IOBus device #5 (0xF301E000). This is fixed in ANS ROMs with Open Firmware 1.1.20.1 and later.
